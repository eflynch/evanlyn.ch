...
/***/ function(module, exports, __webpack_require__) {
	...
	var numBoxes = 12;
	var gridSize = Math.ceil(Math.sqrt(numBoxes)) + 1;
	
	var selectedMass = 80;
	
	var selectedBox = null;
	
	var selectBox = function selectBox(box) {
	    selectedBox = box;
	    renderApp();
	};
	...
	var renderApp = function renderApp() {
	    ...
	    if (prevSelectedBox !== selectedBox) {
	        (0, _reactDom.render)(_react2.default.createElement(_app2.default, { fast: true, hs: hs, vs: vs, selectedBox: selectedBox, onSelect: selectBox }), document.getElementById("content"));
	        timeouts.forEach(function (t) {
	            clearTimeout(t);
	        });
	        timeouts.push(setTimeout(renderApp, 1000));
	    } else {
	        (0, _reactDom.render)(_react2.default.createElement(_app2.default, { fast: false, hs: hs, vs: vs, selectedBox: selectedBox, onSelect: selectBox }), document.getElementById("content"));
	        timeouts.forEach(function (t) {
	            clearTimeout(t);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactFontawesome = __webpack_require__(/*! react-fontawesome */ 169);
	
	var _reactFontawesome2 = _interopRequireDefault(_reactFontawesome);
	
	var _grid = __webpack_require__(/*! ./grid */ 170);
	
	var _grid2 = _interopRequireDefault(_grid);
	
	var _box = __webpack_require__(/*! ./box */ 173);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _grid2.default,
	                        { selectedBox: this.props.selectedBox, fast: this.props.fast, vs: this.props.vs, hs: this.props.hs, onSelect: this.props.onSelect },
	                        _react2.default.createElement(
	                            _box2.default,
	                            null,
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_reactFontawesome2.default, { name: 'th', style: { display: "inline-block", lineHeight: "100%", height: "100%", verticalAlign: "middle" } })
	                            )
	                        ),
	                        ...
	                        _react2.default.createElement(
	                            _box2.default,
	                            null,
	                            _react2.default.createElement('iframe', { src: 'http://evanlyn.ch/static/conway/phase2/phase2.html', style: { width: "100%", height: "100%" } })
	                        ),
	                        _react2.default.createElement(_box2.default, null),
	                        _react2.default.createElement(_box2.default, null),
	                        _react2.default.createElement(_box2.default, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _line = __webpack_require__(/*! ./line */ 171);
	...
	var Grid = function (_React$Component2) {
	    ...
	    function Grid() {
	        ...
	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Grid).call(this));
	    ...
	    _createClass(Grid, [{
	        ...
	        value: function renderChildren() {
	            ...
	            return _react2.default.Children.map(this.props.children, function (box, i) {
	                var gridX = i % (vs.length - 1);
	                var gridY = (i - gridX) / (vs.length - 1);
	                return _react2.default.cloneElement(box, {
	                    v1: vs[gridX],
	                    v2: vs[gridX + 1],
	                    h1: hs[gridY],
	                    h2: hs[gridY + 1],
	                    fast: _this3.props.fast,
	                    selected: _this3.props.selectedBox !== null && gridX === _this3.props.selectedBox[0] && gridY === _this3.props.selectedBox[1],
	                    onClick: function onClick(e) {
	                        onSelect([gridX, gridY]);
	                    }
	                });
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement(GridButton, { onClick: function onClick(e) {
	                        _this4.props.onSelect(null);
	                    }, show: this.props.selectedBox !== null }),
	                this.props.vs.map(function (coord, i) {
	                    return _react2.default.createElement(_line.VLine, { fast: _this4.props.fast, key: i, a: coord[0], b: coord[1] });
	                }),
	                this.props.vs.map(function (coord, i) {
	                    return _react2.default.createElement(_line.VLine, { fast: _this4.props.fast, key: i, a: coord[0], b: coord[1] });
	                }),
	                this.props.hs.map(function (coord, i) {
	                    return _react2.default.createElement(_line.HLine, { fast: _this4.props.fast, key: i, a: coord[0], b: coord[1] });
	                }),
	                this.props.hs.map(function (coord, i) {
	                    return _react2.default.createElement(_line.HLine, { fast: _this4.props.fast, key: i, a: coord[0], b: coord[1] });
	                }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VLine = function (_React$Component) {
	    ...
	    function VLine() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(VLine).apply(this, arguments));
	    }
	...
	var HLine = function (_React$Component2) {
	    _inherits(HLine, _React$Component2);
	
	    function HLine() {
	        _classCallCheck(this, HLine);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(HLine).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Box = function (_React$Component) {
	    ...
	    function Box() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Box).call(this));
	    }
	
	    _createClass(Box, [{
	        key: "intersect",
	        value: function intersect(v, h) {
	            var deltaV = v[1] - v[0];
	            var deltaH = h[1] - h[0];
	        ...
	        value: function render() {
	            ...
	            // Path
	            var path = "polygon(" + 100 * (tl[0] - left) / width + "% " + 100 * (tl[1] - top) / height + "%, " + 100 * (tr[0] - left) / width + "% " + 100 * (tr[1] - top) / height + "%, " + 100 * (br[0] - left) / width + "% " + 100 * (br[1] - top) / height + "%, " + 100 * (bl[0] - left) / width + "% " + 100 * (bl[1] - top) / height + "%)";
	
	            return _react2.default.createElement(
	                "div",
	                _extends({}, this.props, { className: (0, _classnames2.default)({
	                        box: true,
	                        "fast-transitions": this.props.fast,
	                        "slow-transitions": !this.props.fast
	                    }), style: {
